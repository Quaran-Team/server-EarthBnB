insert into todo (
    ...
    "FL",
     TRUE,
    "It’s just like watching your favorite TV shows and movies IRL, except with the ultimate ride-y things like twists, turns and drops. Face villains more menacing than your kids pre-churros. "
    ),(
    ...
    "CO",
        FALSE,
    "Vail, Colorado, is a small town at the base of Vail Mountain, home of the massive Vail Ski Resort. Set within White River National Forest, the town is a gateway for winter sports such as skiing and snowboarding. It’s also a summertime destination for golfing, hiking and cultural festivals. "
    ),(
    ...
    "NC",
    TRUE,
    "Nicknamed ‘America's favorite drive,’ the 469-mile Blue Ridge Parkway was designed by landscape architect Stanley Abbott whose vision was to create a road that was far more than just a way to get from the Great Smoky Mountains National Park in North Carolina to the Shenandoah National Park in Virginia."
    ),(
    ...
    "NC",
    FALSE,
    "Known as the ‘Grand Canyon of the East,’ Linville Gorge is the deepest and one of the most scenic gorges in the eastern United States. Located in the Pisgah National Forest, the Linville River enters the gorge at Linville Falls and drops 90 feet, continuing for 12 miles within the steep rock walls. The trails are accessed at Milepost 316 on the Blue Ridge Parkway."
    ),(
    ...
    "GA",
    TRUE,
    "Learn about the most popular drink in the world. From the original World of Coca‑Cola® that opened on August 3, 1990 at Underground Atlanta, to the opening of  World of Coca‑Cola at Pemberton Place® on May 24, 2007, we are proud to have welcomed over 24 million guests and counting across a span of 25+ years in Atlanta."
    ),(
    ...
    "GA",
    FALSE,
    "Board The Trolley Of Doom to learn about tales of murder, disease and misfortune. Journey through time with exclusive nighttime entry into Savannah’s most haunted venues! Prepare To Be Scared. "
    ),(
